...
object DialogHelper {
     ...
     * @return
     */
    fun showEditDialog(context: Context, title: String?, message: String?, hint: String?, positiveListener: EditDialog.OnSubmitListener? = null): EditDialog {
    ...
    fun showEditDialog(context: Context, title: String?, message: String?, positiveListener: EditDialog.OnSubmitListener? = null): EditDialog {
        return EditDialog.Builder(context)
                .setTitle(title)
                .setMessage(message)
                .setPositiveButton(positiveListener)
